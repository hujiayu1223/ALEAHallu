...
def parse_args():
    ...
    parser.add_argument("--question-file", type=str, default="questions.txt")
    parser.add_argument("--answers-file", type=str, default="answers_copy.txt")
...
def print_acc(pred_list, label_list,args):
    ...
    with open(os.path.join("/home/hjy/work/opera/log/pope/minigpt4/regular", '{}_seed{}.jsonl'.format(args.pope_type,args.seed)), "a") as f:
...
#unlearning
    ...
    save_path = f'{base_dir}/minigpt4-pope-1000-random-pt-chat'
